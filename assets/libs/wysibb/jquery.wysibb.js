...
//			direction:			"ltr",
			...
			allButtons: {
				...
				header : {
					title: 'Заголовок',
					buttonHTML: '<span class="fonticon ve-tlb-italic1"><i class="fa fa-header" aria-hidden="true"></i></span>',
					transform : {
						'<h2>{SELTEXT}</h2>':"[header]{SELTEXT}[/header]"
					}
				},
				underline : {
				...
				link : {
					...
					transform : {
						'<a href="{URL}">{SELTEXT}</a>':"[url={URL}]name={SELTEXT}[/url]",
						'<a href="{URL}">{URL}</a>':"[url=]name={URL}[/url]"
					}
				},
				slider : {
					title: 'Слайдер',
					buttonHTML: '<span class="fonticon ve-tlb-link1"><i class="fa fa-object-group" aria-hidden="true"></i></span>',
					transform : {
						'<section class="slider_array">{SELTEXT}</section>':"[slider]{SELTEXT}[/slider]"
					}
				},
				slide : {
					title: 'Слайд',
					buttonHTML: '<span class="fonticon ve-tlb-link1"><i class="fa fa-plus-square" aria-hidden="true"></i></span>',
					transform : {
						'<div class="slide_mini">{SELTEXT}</div>':"[slide]{SELTEXT}[/slide]"
					}
				},
				img : {
					title: CURLANG.img,
